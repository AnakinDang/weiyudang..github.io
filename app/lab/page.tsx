...
const publicResearchItems = ["Curated summaries", "Design sketches", "Concepts and methods", "Project links"] as const;
      ...
      <section className="lab-hero">
        <div className="container lab-hero-grid">
          <div className="lab-hero-copy">
            <LocalizedText as="p" className="lab-kicker" value="Public research studio" />
            <LocalizedText as="h1" value="Research that can be inspected." />
            <LocalizedText
              as="p"
              value="A public notebook for system sketches, design decisions, build logs, and research fragments around the Personal OS. It shows the method and the evidence without exposing the private operating layer."
            />
            <div className="lab-hero-actions">
              <Link href={latestNote ? `/lab/${latestNote.slug}` : "#lab-notes"} className="link-focus lab-hero-primary">
                <LocalizedText value="Read the latest note" />
                <ArrowRight size={16} aria-hidden />
              </Link>
              <Link href="/projects" className="link-focus lab-hero-secondary">
                <LocalizedText value="Browse projects" />
                <ArrowRight size={16} aria-hidden />
              </Link>
            </div>
            <div className="lab-hero-metrics" aria-label="Research studio summary">
              <span>
                ...
                <LocalizedText as="small" value="public notes" />
              </span>
              <span>
                <strong>{researchLaneCount}</strong>
                <LocalizedText as="small" value="research lanes" />
              </span>
              <span>
                <strong>0</strong>
                <LocalizedText as="small" value="execution controls" />
              </span>
            </div>
          ...
          <aside className="lab-studio-visual" aria-label="Public research studio preview">
            <div className="lab-studio-image-frame">
              ...
              <div className="lab-studio-card">
                <LocalizedText value="Featured note" />
            ...
            <div className="lab-studio-route-strip" aria-label="Research studio route map">
              <span>
                ...
                <LocalizedText value="Observe" />
              </span>
              <span>
                <FlaskConical size={15} aria-hidden />
                <LocalizedText value="Experiment" />
              </span>
              <span>
                <ShieldCheck size={15} aria-hidden />
                <LocalizedText value="Publish safely" />
              </span>
            </div>
            <div className="lab-studio-boundary" role="note" aria-label="Research safety boundary">
              <LockKeyhole size={16} aria-hidden />
              <LocalizedText value="Private vault stays private. Public notes carry only curated evidence." />
            </div>
          </aside>
        </div>
      </section>
      ...
      <section className="lab-protocol-section">
        <div className="container">
          <div className="lab-protocol-grid">
            <div>
              <LocalizedText as="p" className="lab-kicker" value="Publishing protocol" />
              <LocalizedText as="h2" value="From private signal to public artifact." />
            ...
            <div className="lab-boundary-panel">
              <div className="lab-boundary-column">
                <h3>
                  ...
                  <LocalizedText value="Public Research" />
                  <LocalizedText value="Public" />
                </h3>
                {publicResearchItems.map((item) => (
                  <p key={item}>
              ...
              <div className="lab-boundary-column is-private">
                <h3>
                  ...
                  <LocalizedText value="Private Vault" />
                  <LocalizedText value="Private" />
                </h3>
              ...
              <div className="lab-boundary-note">
                <LocalizedText value="We publish what is safe, useful, and durable. Raw prompts, private source notes, credentials, accounts, runtime identifiers, and execution controls stay private by default." />
              </div>
            </div>
          </div>
          ...
          <div className="lab-living-note">
            ...
            <div>
              <LocalizedText as="h2" value="This is a living research shelf." />
              <LocalizedText
                as="p"
                value="New notes land when experiments evolve. The point is not volume; it is a durable trail of decisions, evidence, and useful boundaries."
              />
            </div>
