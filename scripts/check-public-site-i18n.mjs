...
const requiredPublicSiteCopy = {
  home: [
    ...
    "Personal OS route map",
    "Public story",
    "Doraemon signal",
    "Watch public-safe state",
    "Owner decision",
    "Keep approvals private",
    "Research evidence",
    "Read without execution",
    "Personal OS public and private data contract",
    "Public window",
    ...
    "Doraemon Office live preview",
    "Homepage Doraemon Office live public preview",
    "Office preview status",
    ...
    "Closed allowlist",
    "Owner boundary",
    "Private work stays gated",
    "Read-only surface",
    "No public controls",
    "Public-safe roster",
    "Homepage Doraemon Office public boundary",
