...
const exactZhTranslations = {
  ...
  "Personal research studio": "个人研究工作室",
  "Doraemon-ready": "Doraemon 已接入",
  "Homepage Personal OS entry path": "首页 Personal OS 入口路径",
  "Public homepage": "公开主页",
  "Understand the work": "理解工作",
  "Doraemon Office entry": "Doraemon Office 入口",
  "See public-safe agent rhythm": "查看公开安全的智能体节奏",
  "Owner cockpit gate": "私密驾驶舱入口",
  "Keep decisions private": "保持决策私密",
  "Open Personal OS map": "打开 Personal OS 地图",
  "Homepage Personal OS proof points": "首页 Personal OS 证明点",
  "Research in public": "公开研究",
  "Physics, AI, systems": "物理、AI、系统",
  "Doraemon visible": "Doraemon 可见",
  "Agent rhythm, sanitized": "脱敏智能体节奏",
  "Private decisions stay private": "私密决策保持私密",
  "Personal OS public and private boundaries": "Personal OS 的公开与私密边界",
  "Public Studio": "公开工作室",
  ...
  "Weiyu's Personal OS with Doraemon.": "Weiyu 的 Personal OS，Doraemon 协同。",
  "Weiyu's": "Weiyu 的",
  "with Doraemon.": "Doraemon 协同。",
  ...
  "Personal OS connected surfaces": "Personal OS 连接界面",
  "Public-safe Doraemon Office status": "公开安全 Doraemon Office 状态",
  ...
  "Relay is connected; the visible feed keeps the demo-safe snapshot until a public event arrives.":
    "中继已连接；可见活动流会继续展示演示安全快照，直到新的公开事件到达。",
  "Public-safe activity snapshot with live relay heartbeat shown below.":
    "公开安全的活动快照，下方显示实时中继心跳。",
  "Public-safe activity snapshot with relay health shown below.": "公开安全的活动快照，下方显示中继健康状态。",
  "Led by": "负责人",
  "System Heartbeat": "系统心跳",
  "Full-screen bridge": "全屏桥接",
  "Full-screen bridge · dora.weiyudang.com": "全屏桥接 · dora.weiyudang.com",
  "Open full-screen visualizer dora.weiyudang.com in a new tab":
    "在新标签页打开 dora.weiyudang.com 全屏 visualizer",
  "Office Live public context": "Office Live 公开上下文",
  "Doraemon Office public posture": "Doraemon Office 公开状态",
  "Public Doraemon Office stage with sanitized MiniDora state":
    "展示脱敏 MiniDora 状态的公开 Doraemon Office 舞台",
  ...
  "Recent public-safe Doraemon Office activity": "最近公开安全的 Doraemon Office 活动",
  "Live relay · demo activity · Newest first": "实时中继 · 演示活动 · 最新优先",
  "Relay connected · demo snapshot · Newest first": "中继已连接 · 演示快照 · 最新优先",
  ...
  "Relay connected · awaiting public events": "中继已连接 · 等待公开事件",
  "Relay connected · demo snapshot": "中继已连接 · 演示快照",
  "Demo replay · relay reconnecting": "演示回放 · 中继重连中",
  "Demo snapshot · relay reconnecting": "演示快照 · 中继重连中",
  "Demo snapshot": "演示快照",
  ...
  "Coordinate": "统筹",
  "Align priorities and context": "对齐优先级与上下文",
  "Generate insights and evidence": "生成洞察与证据",
  "Build": "构建",
  "Create systems and content": "创建系统与内容",
  "Operate": "运营",
  "Keep things running smoothly": "保持运行顺畅",
  ...
  "Public project dossier": "公开项目档案",
  "Public dossier": "公开档案",
  "Read overview": "阅读概览",
  "Project public-safe map": "项目公开安全地图",
  "Public-safe dossier": "公开安全档案",
  "Project dossier lens": "项目档案镜头",
  "operating lane": "运行通道",
  "boundary mode": "边界模式",
  "linked notes": "关联笔记",
  "System connection": "系统连接",
  "How this project connects back to the Personal OS.": "这个项目如何连接回 Personal OS。",
  "Project connection flow": "项目连接流",
  "Public surface": "公开界面",
  "Curated pages explain the visible project shape.": "精选页面解释项目的可见形态。",
  "Doraemon Office makes status, agents, and rhythm legible.":
    "Doraemon Office 让状态、智能体和节奏变得可理解。",
  "Owner work, source material, prompts, and controls stay gated.":
    "本人工作、来源材料、prompt 和控制项保持门禁保护。",
  "Context, evidence, and next questions": "背景、证据和后续问题",
  "Project pages should explain the public story, name the evidence a visitor can inspect, and keep the next unknowns visible without exposing private work.":
    "项目页应该解释公开叙事，标出访客可检查的证据，并让后续未知问题保持可见，同时不暴露私密工作。",
  "Where this artifact sits inside the Personal OS.": "这个成果位于 Personal OS 的什么位置。",
  "Public role": "公开角色",
  "Operating lane": "运行通道",
  "Boundary mode": "边界模式",
  "What a visitor can inspect without crossing the private boundary.": "访客在不跨越私密边界的情况下可以检查什么。",
  "Curated project body": "精选项目正文",
  "Markdown body explains only public-safe context.": "Markdown 正文只解释公开安全的上下文。",
  "Reviewed routes": "已审阅入口",
  "Links are either public-safe or owner-gated.": "链接要么公开安全，要么由本人门禁保护。",
  "Links stay on public-safe routes.": "链接保持在公开安全路由上。",
  "Related public research note attached.": "已附加相关公开研究笔记。",
  "No public related note yet.": "暂时没有相关公开研究笔记。",
  "Next questions": "后续问题",
  "Open questions keep the project from becoming a static portfolio card.":
    "开放问题让项目不变成静态作品集卡片。",
  "Source freshness": "来源新鲜度",
  "Public summary": "公开摘要",
  "Owner route": "本人路由",
  "Artifact": "成果",
  "Public route": "公开路由",
  "Office feedback": "Office 反馈",
  "Which evidence is still missing before owner review?": "本人审核前还缺哪些证据？",
  "Where do the research desks disagree?": "各研究台在哪些地方意见不同？",
  "Which sources need freshness checks?": "哪些来源需要新鲜度检查？",
  "What can be safely summarized for the public site?": "哪些内容可以安全地总结到公开站？",
  "Which routes must stay owner-only?": "哪些路由必须保持仅本人可见？",
  "What evidence can become a public research note?": "哪些证据可以变成公开研究笔记？",
  "What artifact proves the next step?": "哪个成果能证明下一步？",
  "Which public route should this connect to?": "这应该连接到哪个公开路由？",
  "What should feed back into Doraemon Office?": "什么应该反馈回 Doraemon Office？",
  "Project links": "项目链接",
  ...
  "Tool details, artifacts, memory records, accounts, or local paths.": "工具细节、产物、记忆记录、账户或本地路径。",
  ...
  "Field context": "现场背景",
  "Observation, place, and memory": "观察、地点与记忆",
  "Journal entries are the softer shelf of the Personal OS: public enough to share the life around the work, quiet enough to stay personal.":
    "日志是 Personal OS 更柔软的一层：足够公开，可以分享工作周围的生活；足够安静，可以保持个人感。",
  "Observation lens": "观察镜头",
  "How this entry should be read.": "这篇条目应该如何被阅读。",
  "Public note": "公开笔记",
  "A personal field note, not an operations log.": "一篇个人现场笔记，而不是操作日志。",
  "Journal lane": "日志轨道",
  "Place marker": "地点标记",
  "Memory cues": "记忆线索",
  "The sensory anchors that make the note specific.": "让这篇笔记变得具体的感官锚点。",
  "Visual anchor": "视觉锚点",
  "Image-led entry with a public-safe cover.": "由图片引导，并配有公开安全封面的条目。",
  "Time marker": "时间标记",
  "Human texture": "人的质感",
  "Quiet frames, light, texture, and visual memory.": "安静的画面、光线、质感和视觉记忆。",
  "Small human details around the technical work.": "技术工作周围细小而真实的生活细节。",
  "Fragments that may later become projects or essays.": "未来可能发展成项目或文章的片段。",
  "A soft public note beside the technical studio.": "技术工作室旁边一篇柔软的公开笔记。",
  "Connection back": "回到主线",
  "How the journal stays connected without becoming operational.": "日志如何保持连接，但不变成操作界面。",
  "Studio boundary": "工作室边界",
  "Personal context stays public; private work stays out.": "个人语境保持公开安全；私密工作留在边界之外。",
  "Personal OS role": "Personal OS 角色",
  "Keeps the site warm beside the technical studio.": "让网站在技术工作室之外保留温度。",
  "Next shelf": "下一层架子",
  "Future photo essay or small gallery.": "未来的摄影短文或小型图库。",
  "A small personal note that can stay light.": "一篇可以保持轻盈的小型个人笔记。",
  "A fragment that can mature into research or project context.":
    "一个未来可以长成研究或项目语境的片段。",
  "A public journal note that can stay human and light.":
    "一篇可以保持人味和轻盈感的公开日志。",
  ...
  "Structured for public reading: enough context to understand the work, enough evidence to inspect it, and enough open questions to keep it honest.":
    "按公开阅读来组织：给出足够理解工作的背景、可检查的证据，以及让研究保持诚实的开放问题。",
  "Research context": "研究背景",
  "Where this note sits inside the Personal OS research studio.":
    "这篇笔记位于 Personal OS 研究工作室的什么位置。",
  "Frames this as a public-safe research artifact, not a private source record.":
    "把这篇内容定位为公开安全的研究成果，而不是私密来源记录。",
  "Research lane": "研究通道",
  "Published posture": "发布状态",
  "Published": "发布时间",
  "What a reader can inspect without crossing the private boundary.":
    "读者在不跨越私密边界的情况下可以检查什么。",
  "Curated note body": "精选笔记正文",
  "The note below is the public-safe narrative.": "下方正文是公开安全叙事。",
  "A public project route is attached.": "已附加一个公开项目路由。",
  "No public project route attached yet.": "暂时没有附加公开项目路由。",
  "Artifact links": "成果链接",
  "Public artifact links are attached.": "已附加公开成果链接。",
  "No public artifact links yet.": "暂时没有公开成果链接。",
  "Open questions keep the note tied to future research.": "开放问题让这篇笔记继续连接到后续研究。",
  "Which proof is still missing before owner review?": "本人审核前还缺哪些证明？",
  "Where should opposing evidence stay visible?": "反向证据应该在哪些地方保持可见？",
  "Keep this as research only, never an execution path.": "保持为研究用途，永远不要变成执行路径。",
  "Which signals can be shown without exposing private work?": "哪些信号可以展示，同时不暴露私密工作？",
  "Office route": "Office 路由",
  "Which Doraemon Office route should this improve next?": "下一步应该改善哪个 Doraemon Office 路由？",
  "Demo fallback": "演示回退",
  ...
  "Which MiniDora responsibility becomes clearer from this note?":
    "这篇笔记让哪个 MiniDora 职责变得更清楚？",
  "Where should owner judgment remain explicit?": "哪些地方应该明确保留本人判断？",
  "Public artifact": "公开成果",
  "What durable artifact can prove the next step?": "哪个可长期保存的成果能证明下一步？",
  "Design choice": "设计选择",
  "Which visual or product decision needs evidence?": "哪个视觉或产品决策需要证据？",
  "Tradeoff": "取舍",
  "What did the design intentionally leave out?": "这个设计刻意没有包含什么？",
  "Next prototype": "下一个原型",
  "Which surface should carry the next fidelity pass?": "下一轮高保真应该落在哪个界面？",
  "Build evidence": "构建证据",
  "Which checks prove the implementation is stable?": "哪些检查能证明实现是稳定的？",
  "Failure mode": "失败模式",
  "Which unsafe or brittle path should stay visible?": "哪些不安全或脆弱路径应该保持可见？",
  "Next check": "下一项检查",
  "What should be verified before this becomes a pattern?": "在它成为模式前还需要验证什么？",
  "Asset system": "资产系统",
  "Which reusable visual language should survive the experiment?":
    "哪些可复用视觉语言应该从实验中保留下来？",
  "Taste check": "审美检查",
  "What would make the output feel less generic?": "什么能让输出不那么模板化？",
  "Production memory": "生产记忆",
  "Which settings or lessons should be preserved publicly?": "哪些设置或经验应该被公开保留下来？",
  "Rhythm": "节奏",
  "Which recurring signal is useful enough to publish?": "哪个周期性信号足够有用，值得公开？",
  "Health signal": "健康信号",
  "What can be summarized without exposing system internals?": "哪些内容可以总结，同时不暴露系统内部？",
  "Which operational actions must stay private?": "哪些运维动作必须保持私密？",
  "Research question": "研究问题",
  "What should the public note make easier to understand?": "公开笔记应该帮助读者更容易理解什么？",
  "Which artifact can readers inspect safely?": "读者可以安全检查哪个成果？",
  "Next synthesis": "下一次综合",
  "What should become clearer in the next note?": "下一篇笔记应该让什么变得更清楚？",
  "Note": "笔记",
  ...
  "tool details, accounts, and credentials": "工具细节、账户和凭据",
  ...
  "Public command spine": "公开指挥主线",
  "Only sanitized state crosses into these routes.": "只有脱敏状态会进入这些路由。",
  "Current Office surface": "当前 Office 界面",
  "Doraemon Office public command spine": "Doraemon Office 公开指挥主线",
  "Doraemon Office read-only route map": "Doraemon Office 只读路由地图",
  "Current public boundary": "当前公开边界",
  "Command stage": "指挥舞台",
  "Event timeline": "事件时间线",
  "Agent roster": "智能体花名册",
  "Knowledge synthesis": "知识综合",
  "No owner controls render in public.": "公开界面不渲染本人控制入口。",
  "No private task names or prompts appear.": "不显示私密任务名或提示词。",
  "No raw vault pages or memory records render.": "不渲染原始知识库页面或记忆记录。",
  "No run internals appear.": "不显示运行内部信息。",
  "No owner notes appear.": "不显示本人笔记。",
  "No automation internals render.": "不渲染自动化内部信息。",
  "No private operations render.": "不渲染私密运维信息。",
  "Owner private": "本人私密",
  ...
  "Owner review runway": "本人审核跑道",
  "Next research decisions": "下一步研究决策",
  "Research decision chain": "研究决策链路",
  "Review path": "审核路径",
  "Review path step 1": "审核路径第 1 步",
  "Review path step 2": "审核路径第 2 步",
  "Review path step 3": "审核路径第 3 步",
  "Review path step 4": "审核路径第 4 步",
  "Research posture changes only after this chain is reviewed.": "只有这条链路完成审核后，研究姿态才会改变。",
  "Evidence blockers": "证据阻塞点",
  "Next question": "下一个问题",
  "Review queue clear": "审核队列清晰",
  "Evidence runway clear": "证据跑道清晰",
  "Source model empty": "来源模型为空",
  "No open question": "暂无开放问题",
  "No owner-only review blockers are open in this session.": "当前会话没有仅本人可见的审核阻塞点。",
  "No open evidence blockers in the owner-only research queue.": "仅本人可见的研究队列中没有开放证据阻塞点。",
  ...
  "Open replay trace for Source provenance missing": "打开“来源可信度缺失”的回放追踪",
  "Open replay trace for Counter-evidence required": "打开“需要反证”的回放追踪",
  "Open replay trace for Missing liquidity check": "打开“缺少流动性检查”的回放追踪",
  "Trading research status": "交易研究状态",
  "Trading research continuity": "交易研究连续性",
  "Trading research posture": "交易研究姿态",
  "Trading research boundary": "交易研究边界",
  "Trading research views": "交易研究视图",
  "Trading research cockpit summary": "交易研究驾驶舱摘要",
  "Desk signal filters": "研究台信号筛选",
  ...
  "Company evidence packet missing.": "缺少公司证据包。",
  "Company packet": "公司包",
  "Company-level source coverage is missing.": "缺少公司层面的来源覆盖。",
  ...
  "Treat liquidity as unavailable until provenance improves.": "在来源可信度改善前，将流动性视为不可用。",
  ...
  "Owner access": "私密访问",
  "Private app navigation": "私密应用导航",
  "Private app mobile navigation": "私密应用移动导航",
  "Sign out of Owner Cockpit": "退出私密驾驶舱",
  "Password": "密码",
  "Continue": "继续",
